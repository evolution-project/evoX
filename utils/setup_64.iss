...
#define MyAppName "Evox"
;#define MyAppVersion "0.2.0.31"
#define MyAppPublisher "Evox Team"
#define MyAppURL "http://zano.org"
#define MyAppExeName "Evox.exe"
...
[Registry]
Root: HKCR; Subkey: ".dbl"; ValueType: string; ValueName: ""; ValueData: "EvoxWalletDataFile"; Flags: uninsdeletevalue
Root: HKCR; Subkey: "EvoxWalletDataFile"; ValueType: string; ValueName: ""; ValueData: "Evox Wallet's Data File"; Flags: uninsdeletekey
Root: HKCR; Subkey: "EvoxWalletDataKyesFile"; ValueType: string; ValueName: ""; ValueData: "Evox Wallet's Keys File"; Flags: uninsdeletekey

Root: HKCR; Subkey: "EvoxWalletDataFile\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\Evox.exe,0"
Root: HKCR; Subkey: "EvoxWalletDataKyesFile\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\Evox.exe,0"

Root: HKCR; Subkey: "Evox"; ValueType: string; ValueName: "URL Protocol"; ValueData: ""
Root: HKCR; Subkey: "Evox\shell\open\command"; ValueType: string; ValueName: ""; ValueData: "{app}\Evox.exe --deeplink-params=%1"
