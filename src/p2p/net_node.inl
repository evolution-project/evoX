...
namespace nodetool
{
  ...
  const static boost::uuids::uuid P2P_NETWORK_ID = { { 0x11, 0xFF, 0xFF, 0x88, 0x11, 0xFF, 0x66, 0x11, 0x1F, 0x10, P2P_NETWORK_ID_TESTNET_FLAG, 0x11, 0xFF, 0x22, 0x66, P2P_NETWORK_ID_VER} };
